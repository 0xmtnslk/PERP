...
class UserTradingEngine:
    def __init__(self):
        ...
        self.users_dir = os.path.join(self.BASE_DIR, "production", "exchanges", "PERP", "users")
    ...
    def heartbeat_writer(self):
        ...
        while True:
            try:
                ...
                logger.error(f"❌ Health file yazma hatası: {e}")
            time.sleep(60)
    ...
    def start_heartbeat(self):
        ...
        logger.info("💓 User Trading Engine heartbeat başlatıldı")
